    ...
    <div class="container-fluid">
        <div class="row align-items-center encabezado">
            <div class="col" align="center">
                <a href="index.html"><img id="logo-encabezado" src="img/bacaro.png" alt="BACARO Online Store"></a>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col menu">
                        <div class="dropdown">
                            ...
                            <a href="login.html"><i class="fas fa-shopping-cart icon"></i>Mi carrito</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col">
                        <a href="">
                            <div class="tarjeta-vendido grow">
                                <div class="tarjeta-vendido-img"><img src="https://goo.gl/X4N1gD" alt="PlayStation 4"></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h4 class="no-margin-text">1. </h4><h4 class="no-margin-text">PlayStation 4</h4></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h5 class="no-margin-text">$7, 999</h5></div>
                            </div>
                        </a>
                    </div>
                    <div class="col">
                        <a href="">
                            <div class="tarjeta-vendido grow">
                                <div class="tarjeta-vendido-img"><img src="https://goo.gl/va9EhS" alt="Nintendo Switch"></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h4 class="no-margin-text">2. </h4><h4 class="no-margin-text">Nintendo Switch</h4></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h5 class="no-margin-text">$7, 499</h5></div>
                            </div>
                        </a>
                    </div>
                    <div class="col">
                        <a href="">
                            <div class="tarjeta-vendido grow">
                                <div class="tarjeta-vendido-img"><img src="https://goo.gl/EzRqzN" alt="Macbook Pro 2017"></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h4 class="no-margin-text">3. </h4><h4 class="no-margin-text">Macbook Pro</h4></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h5 class="no-margin-text">$39, 999</h5></div>
                            </div>
                        </a>
                    </div>
                    <div class="col">
                        <a href="">
                            <div class="tarjeta-vendido grow">
                                <div class="tarjeta-vendido-img"><img src="https://goo.gl/vqf6Jj" alt="JBL GO"></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h4 class="no-margin-text">4. </h4><h4 class="no-margin-text">Bocina JBL GO</h4></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h5 class="no-margin-text">$499</h5></div>
                            </div>
                        </a>
                    </div>
                    <div class="col">
                        <a href="">
                            <div class="tarjeta-vendido grow">
                                <div class="tarjeta-vendido-img"><img src="https://goo.gl/Y2Ju26" alt="iPhone X"></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h4 class="no-margin-text">5. </h4><h4 class="no-margin-text">iPhone X</h4></div>
                                <div class="tarjeta-texto subtitulo" align="center"><h5 class="no-margin-text">$23, 499</h5></div>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="row tarjetas-explorar" align="center">
            ...
            <div class="w-100"></div>
            <div class="col">
                <a href="#"><img src="img/tarjetaCamaras.png" alt="Tarjeta camaras"></a>
            </div>
            <div class="col">
                <a href="#"><img src="img/tarjetaTablets.png" alt="Tarjeta tablets"></a>
            </div>
            ...
            <div id="seccion-descubrir" class="col">
                ...
                <div class="tarjetas-mini">
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/HdBnw3" alt="Nintendo Switch"></a>
                    </div>
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/xGTLqt" alt="Joycon Neon"></a>
                    </div>
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/GNRs7w" alt="Joycon Pro Controller"></a>
                    </div>
                    <div class="tarjeta-mini tarjeta-mini-ultima">
                        <a href="#"><img src="https://goo.gl/XRvNxH" alt="Nintendo Switch case"></a>
                    </div>
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/MWEFzF" alt="The Legend of Zelda: Breath of the Wild"></a>
                    </div>
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/N5tHKV" alt="Super Mario Odyssey"></a>
                    </div>
                    <div class="tarjeta-mini">
                        <a href="#"><img src="https://goo.gl/mcQd1d" alt="Xenoblade Chronicles 2"></a>
                    </div>
                    <div class="tarjeta-mini tarjeta-mini-ultima">
                        <a href="#"><img src="https://goo.gl/5Jp93X" alt="Mario Kart 8 Deluxe"></a>
                    </div>
                </div> <!-- tarjetas-mini -->
