        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <div class="col" id="dashboard">
                <div class="row">
                    ...
                    <div class="col-3 tarjeta-info">
                        <div class="tarjeta-contenido tarjeta2">
                            <h6>Total de <strong>VENTAS</strong></h6>
                            <h1 id="total-ventas">6, 399</h1>
                        </div>
                        <div class="tarjeta-footer tarjeta2-footer">
                            <span id="incremento-ventas">11%</span> <span> decremento en ventas</span>
                        </div>
                    </div>
                    <div class="col-3 tarjeta-info">
                        <div class="tarjeta-contenido tarjeta3">
                            <h6>Total de <strong>INGRESOS</strong></h6>
                            <h1 id="total-ingresos">$70, 389</h1>
                        </div>
                        <div class="tarjeta-footer tarjeta3-footer">
                            <span id="incremento-ingresos">7%</span> <span> decremento en ingresos</span>
                        </div>
                    </div>
                    <div class="col-3 tarjeta-info">
                        <div class="tarjeta-contenido tarjeta4">
                            <h6>Total de <strong>USUARIOS</strong></h6>
                            <h1 id="total-usuarios">18, 648</h1>
                        </div>
                        <div class="tarjeta-footer tarjeta4-footer">
                            <span id="incremento-usuarios">6%</span> <span> incremento de usuarios</span>
                        </div>
                    </div>

                    <div class="w-100"></div>

                    <div id="grafica-linea" class="col">
