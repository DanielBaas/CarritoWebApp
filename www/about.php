...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col seccion-acerca">
            <div class="row">
                <div class="col acerca-elemento">
                    <h1>Acerca de Bacaro Online Store</h1>
                </div>
            </div>
            <div class="row acerca-elemento">
                <div class="col">
                    <h3>Nuestro objetivo: brindarte el mejor servicio</h3>
                    <p>
                        BACARO Online Store tiene como objetivo brindar una excelente experiencia para el usuario. Queremos
                        ofrecerte los mejores productos a precios competitivos, con envíos rápidos y seguros hasta tu hogar.
                    </p>
                </div>
                <div class="col">
                    <div class="acerca-img">
                        <img src="img/happy.jpg" alt="Cliente feliz">
                    </div>
                </div>
            </div>
            <div class="row acerca-elemento">
                <div class="col">
                    <div class="acerca-img">
                        <img src="img/brand.jpg" alt="Marcas">
                    </div>
                </div>
                <div class="col">
                    <h3>Las marcas nos respaldan</h3>
                    <p>
                        Contamos con una gran variedad de productos de marcas reconocidas, así podemos asegurar que cuando compras
                        un producto estás comprando algo de calidad que va de acuerdo a tus necesidades.
                    </p>        
                </div>
            </div>
            <div class="row acerca-elemento">
                <div class="col">
                    <h3>Siempre en contacto contigo</h3>
                    <p>
                        ¿Tienes alguna duda, problema o sugerencia? ¡Estamos para servirte! El servicio de atención al cliente de
                        BACARO Online Store está a tu disposición las 24 horas del día. Nos aseguraremos que resolver tu problema
                        lo más pronto posible y de la mejor manera para que siempra puedas confiar en nosotros.
                    </p>        
                </div>
                <div class="col">
                    <div class="acerca-img">
                        <img src="img/servicio-cliente.png" alt="Servicio al cliente">
                    </div>
                </div>
            </div>
